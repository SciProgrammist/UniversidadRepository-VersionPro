...
@Entity
@Table(name = "personas")
@Inheritance(strategy = InheritanceType.JOINED) //This annotacion is used when we have an abstract class, which has been inherited.
/*@JsonTypeInfo(
...
@JsonSubTypes({
        @JsonSubTypes.Type(value = Alumno.class, name = "alumno"), //Cuando venda un tipo alumno va a hacer la instancia de esa clase.
