...
public class Aula implements Serializable {
    ...
    @Enumerated(EnumType.STRING) //Para poder persistir el unemerador se usa esta anotacion.
    ...
    //Mediante el ORM se utilizan las siguientes anotaciones para crear las cardinalidades a las diferentes tablas.
    @ManyToOne(
            optional = true,
            cascade = {
                    CascadeType.PERSIST,
