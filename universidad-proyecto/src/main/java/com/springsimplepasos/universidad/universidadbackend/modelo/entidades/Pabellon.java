...
public class Pabellon implements Serializable {
    ...
    @Embedded //Esta anotacion hace que los atributos de la clase Direccion aparescan como parte de la tabla de la clase
    //y no como una tabla aparte.
    @AttributeOverrides({
    ...
    private Set<Aula> aulas; //Se usa para cuando se quiere tener un unico objeto en la coleccion Set.
    public Pabellon() {
    }
